...
public class Regex {
	...
	/**
	 * 手机号码正则表达式=^(13\\d|14[57]|15[^4,\\D]|17[13678]|18\\d)\\d{8}|170[^346,\\D]\\d{7}$
	 */
	public static final String MOBILE = "^(13\\d|14[579]|15[^4,\\D]|17[135678]|18\\d)\\d{8}|170[^346,\\D]\\d{7}$";
	/**
	 ...
	 * 检查是否存在特殊字符串正则 regEx=".*[`~!@#$%^&*()+=|{}':;',\\[\\].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“’。，、？]+.*";
	 */
	public static final String STR_FULL_SPECIAL = ".*[`~!@#$%^&*()+=|{}':;',\\[\\].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“’。，、？]+.*";
	/***
	...
	public static final String PASSWORD_REGEXP = "^[\\S]{6,16}$";
	...
	public static boolean isINTEGER_NEGATIVE(String str) {
		return isRegular(str, INTEGER_NEGATIVE);
	}
	...
	public static boolean isINTEGER_POSITIVE(String str) {
		return isRegular(str, INTEGER_POSITIVE);
	}
	...
	public static boolean isDOUBLE_NEGATIVE(String str) {
		return isRegular(str, DOUBLE_NEGATIVE);
	}
	...
	public static boolean isDOUBLE_POSITIVE(String str) {
		return isRegular(str, DOUBLE_POSITIVE);
	}
	...
	public static boolean isDate1(String str) {
		return isRegular(str, DATE_FORMAT1);
	}
	...
	public static boolean isLengOut(String str, int leng) {
		return Assert.notEmpty(str) && str.trim().length() > leng;
	}
	...
	public static boolean isENG_NUM(String str) {
		return isRegular(str, STR_ENG_NUM);
	}
	...
	public static boolean isENG_NUM_(String str) {
		return isRegular(str, STR_ENG_NUM_);
	}
	...
	public static boolean hasSpecialCharStr(String str){
		Pattern p = Pattern.compile(STR_FULL_SPECIAL);
		Matcher m = p.matcher(str);
		return m.matches();
	}
	...
	public static boolean isJigouCode(String str) {
		return isRegular(str, JIGOU_CODE);
	}
	...
	public static boolean isPassword(String str) {
		return isRegular(str, PASSWORD_REGEXP);
	}
	 ...
	 * @return boolean
	 */
	public static boolean isRegular(String str, String pattern) {
